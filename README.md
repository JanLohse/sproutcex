...
deterministic :math:`\omega`-automata with *informative right congruence* from smallest
counterexamples. **SproutCEX** is built upon the passive learner **Sprout** presented by
Bohn and Löding in *Constructing Deterministic* :math:`\omega`*-Automata from Examples
